...
const showcaseItems = [
  {
    ...
    description: "Just take a photo and Bob analyzes everything - portions, calories, even hidden ingredients",
  ...
  },
  {
    ...
    description: "Wake up to encouraging messages and reminders tailored to your progress",
  ...
  },
  {
    ...
    description: "Vegan? Keto? Allergies? Bob remembers and adjusts all recommendations",
  ...
  },
  {
    ...
    description: "Get personalized insights about your progress and smart adjustments for next week",
  ...
  },
  {
    ...
    description: "Beautiful charts show your weight trend and help you stay motivated",
  ...
  },
  {
    ...
    description: 'Say "had McDonald\'s" and Bob asks "What did you order? Any sauces?" - catching calories you might miss',
                  ...
                  <div className="relative mx-auto w-full max-w-[320px]">
                    ...
                    <div className="relative aspect-[390/844] w-full">
                      ...
                      <div className="absolute inset-[3%] overflow-hidden rounded-[2.5rem] bg-white dark:bg-gray-900">
                        ...
                        <div className={`h-full bg-gradient-to-br ${item.gradient} flex items-center justify-center p-4`}>
