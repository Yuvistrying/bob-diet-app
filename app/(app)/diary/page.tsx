              ...
              <div>
                ...
                {isToday && (
                  ...
                  >
                    <div className="p-4 flex items-center justify-center gap-3">
                      ...
                      <span className="font-medium text-foreground">Add food entry</span>
                    </div>
                  </div>
                )}
                ...
                {foodLogs && foodLogs.length > 0 ? (
                  <div className="space-y-3">
                    {foodLogs.map((log) => (
                      <div key={log._id} className="border border-border rounded-lg">
                        <div className="p-3">
                          <div className="flex justify-between items-start mb-2">
                            <div className="font-medium text-foreground">{log.time}</div>
        ...
        <TabsContent value="weight" className="mt-0 flex-1 overflow-hidden">
          <div className="h-full overflow-y-auto pb-24">
            ...
            {currentWeekData && (
              <div className="border border-border rounded-lg">
                <div className="p-4">
                              ...
                              <div className="flex-1">
                                ...
                                {today.weight ? (
                                  ...
                                  <div className="flex items-center gap-2 mt-2">
                                    ...
                                    <span className="text-sm text-muted-foreground">Log weight</span>
                                  </div>
                                )}
                              </div>
                              {today.weight && (
                  ...
                  <div>
                    <h4 className="text-sm font-medium mb-2 text-muted-foreground">Previous Days</h4>
            ...
            {weeklyTrends && weeklyTrends.length > 0 && (
              <div className="border border-border rounded-lg">
                <div className="p-4">
                  <h3 className="text-lg font-semibold mb-3 text-foreground">Recent Trends</h3>
            ...
            <div className="max-w-lg mx-auto mb-4 border border-border rounded-lg">
              <div className="p-4">
                ...
                >
                  <h3 className="text-lg font-semibold text-foreground">Full Log History</h3>
                  {showFullHistory ? (
    ...
    {/* Add Dialog */}
      <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
        <DialogContent className="border-border">
          <DialogHeader>
            <DialogTitle className="text-foreground">{addType === "food" ? "Add Food Entry" : "Log Weight"}</DialogTitle>
          </DialogHeader>
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent className="border-border">
          <DialogHeader>
            <DialogTitle className="text-foreground">Edit Food Entry</DialogTitle>
          </DialogHeader>
      ...
      <Dialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        <DialogContent className="border-border">
          <DialogHeader>
            <DialogTitle className="text-foreground">Delete Food Entry?</DialogTitle>
          </DialogHeader>
      ...
      <Dialog open={editWeightDialogOpen} onOpenChange={setEditWeightDialogOpen}>
        <DialogContent className="border-border">
          <DialogHeader>
            <DialogTitle className="text-foreground">Edit Weight Entry</DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            <div>
