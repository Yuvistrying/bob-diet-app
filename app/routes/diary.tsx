              ...
              <div className="grid grid-cols-2 gap-2 p-3 border-b border-gray-200 dark:border-gray-800">
                <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                  <CardContent className="p-2 text-center">
                    <div className="text-xs text-muted-foreground dark:text-gray-400 uppercase tracking-wider font-mono">
                      🔥 Calories
                    </div>
                        ...
                        <CardContent className="p-3">
                          ...
                          {!isStealthMode && (
                            <div className="text-xs text-gray-500 dark:text-gray-400 font-mono">
                              {log.totalCalories} kcal • {log.totalProtein}g
                              Protein • {log.totalCarbs}g Carbs • {log.totalFat}
                              g Fats
                            </div>
                          )}
                        </CardContent>
            ...
            {currentWeekData && (
              <Card className="max-w-lg mx-auto bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                <CardContent className="p-4">
                  ...
                  <div>
                    <h4 className="text-sm font-medium mb-2 text-muted-foreground dark:text-gray-400">
                      Previous Days
                    </h4>
