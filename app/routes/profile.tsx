                ...
                <CardContent className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="mt-1 p-2 bg-gray-100 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700">
                      <div className="text-lg font-semibold font-mono text-gray-900 dark:text-gray-100">
                        🏁{" "}
                        {activeGoal?.startingWeight ||
                          profile?.currentWeight ||
                          "—"}{" "}
                        {activeGoal?.startingUnit ||
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      step="0.1"
                      value={
                        isEditing ? formData.targetWeight : profile.targetWeight
                      }
                      onChange={(e) => {
                  ...
                  <div>
                    ...
                    >
                      <ToggleGroupItem
                        value="female"
                        className="data-[state=on]:bg-primary data-[state=on]:text-primary-foreground border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300"
                      >
                        Female
                      </ToggleGroupItem>
                      <ToggleGroupItem
