...
export const modalConfig = {
  ...
  content: {
    ...
    animation: 'animate-in fade-in-0 zoom-in-95 slide-in-from-bottom-2 duration-300'
  }
};
...
export const navigationConfig = {
  ...
  button: 'w-[44px] h-[44px] flex items-center justify-center rounded-full active:bg-white/10',
